...
function Details(){
    ...
    const message = "Olá, "+incident.name+'. Estou entrando em contato para ajudar no caso  "'+incident.title+'" com o valor de '
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.contactBox}>
                ...
                <Text style={styles.description}>Entre em conato:</Text>
